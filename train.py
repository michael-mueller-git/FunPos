...
if __name__ == '__main__':
    ...
    for epoch in range(1, EPOCHS+1):
        ...
        model.train()
        for param_group in scheduler.optimizer.param_groups: print('lr: %s'% param_group['lr'])
        ...
        for frames, pos in pbar:
            ...
            # print("prediction:", out_pos, "gt:", pos)
        ...
        if not os.path.exists(config.checkpoints_dir): os.mkdir(config.checkpoints_dir)
